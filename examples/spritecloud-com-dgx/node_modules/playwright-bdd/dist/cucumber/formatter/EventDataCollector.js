...
class EventDataCollector {
    ...
    parseEnvelope(envelope) {
        if ((0, valueChecker_1.doesHaveValue)(envelope.gherkinDocument?.uri)) {
            this.gherkinDocumentMap[envelope.gherkinDocument.uri] = envelope.gherkinDocument;
        }
        else if ((0, valueChecker_1.doesHaveValue)(envelope.pickle)) {
            this.pickleMap[envelope.pickle.id] = envelope.pickle;
        }
        else if ((0, valueChecker_1.doesHaveValue)(envelope.undefinedParameterType)) {
            this.undefinedParameterTypes.push(envelope.undefinedParameterType);
        }
        else if ((0, valueChecker_1.doesHaveValue)(envelope.testCase)) {
            this.testCaseMap[envelope.testCase.id] = envelope.testCase;
        }
        else if ((0, valueChecker_1.doesHaveValue)(envelope.testCaseStarted)) {
            this.initTestCaseAttempt(envelope.testCaseStarted);
        }
        else if ((0, valueChecker_1.doesHaveValue)(envelope.attachment)) {
            this.storeAttachment(envelope.attachment);
        }
        else if ((0, valueChecker_1.doesHaveValue)(envelope.testStepFinished)) {
            this.storeTestStepResult(envelope.testStepFinished);
        }
        else if ((0, valueChecker_1.doesHaveValue)(envelope.testCaseFinished)) {
    ...
    storeAttachment(attachment) {
        ...
        if ((0, valueChecker_1.doesHaveValue)(testCaseStartedId) && (0, valueChecker_1.doesHaveValue)(testStepId)) {
            const { stepAttachments } = this.testCaseAttemptDataMap[testCaseStartedId];
            if ((0, valueChecker_1.doesNotHaveValue)(stepAttachments[testStepId])) {
...
//# sourceMappingURL=EventDataCollector.js.map