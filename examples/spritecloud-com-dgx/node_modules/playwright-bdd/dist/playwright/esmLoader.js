...
function registerESMLoader() {
    ...
    if (utils_1.playwrightVersion >= '1.61.0')
        return;
...
function getESMLoaderMethods() {
    ...
    const { registerESMLoader } = utils_1.playwrightVersion >= '1.60.0'
        ? (0, utils_1.requirePlaywrightModule)('lib/common/index.js').esm
        : (0, utils_1.requirePlaywrightModule)('lib/common/esmLoaderHost.js');
