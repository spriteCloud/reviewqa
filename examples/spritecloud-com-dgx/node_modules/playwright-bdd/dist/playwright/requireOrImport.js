...
function getTransformMethods() {
    ...
    const { requireOrImport } = utils_1.playwrightVersion >= '1.60.0'
        ? (0, utils_1.requirePlaywrightModule)('lib/common/index.js').transform
        : (0, utils_1.requirePlaywrightModule)('lib/transform/transform.js');
