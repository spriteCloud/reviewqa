...
const TagsFromPathInjector_1 = require("./TagsFromPathInjector");
...
class FeaturesLoader {
    constructor() {
        ...
        this.parseErrors = [];
        this.tagsFromPathInjector = new TagsFromPathInjector_1.TagsFromPathInjector(newId);
    }
    ...
    getDocumentsWithPickles() {
        const picklesByUri = new AutofillMap_1.AutofillMap();
