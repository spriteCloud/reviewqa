...
const envelopesTransformer_1 = require("./envelopesTransformer");
...
class HtmlReporter extends base_1.default {
    ...
    async init() {
        const envelopesTransformer = new envelopesTransformer_1.EnvelopesTransformer(this.messagesBuilder);
