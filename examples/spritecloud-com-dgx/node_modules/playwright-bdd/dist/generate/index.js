...
class TestFilesGenerator {
    constructor(config) {
        ...
        if (config.tags)
            this.tagsExpression = (0, tag_expressions_1.parse)(config.tags);
    }
    async generate() {
    ...
    checkStepDefinitionArityErrors() {
        const stepDefinitionArityErrors = this.files.flatMap((file) => file.getStepDefinitionArityErrors());
