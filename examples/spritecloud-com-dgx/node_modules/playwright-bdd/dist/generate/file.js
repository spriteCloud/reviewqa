...
const documentQuery_1 = require("../gherkin/documentQuery");
...
class TestFile {
    ...
    renderTechnicalSection() {
        ...
        const testUse = this.formatter.testUse([
            ...
            ...(supportedFeatures_1.supportedFeatures.ariaSnapshots && this.config.aiFix?.promptAttachment
    ...
    renderTest(pickle, testTitle, ownTestTags, gherkinSteps) {
        const testTags = (0, utils_1.removeDuplicates)((0, helpers_1.getTagNames)(pickle.tags));
    ...
    findPickle(astNodeId, testTitle) {
        ...
        if (!pickle) {
            (0, exit_1.exit)(`Pickle not found for scenario: ${testTitle}`);
        }
        else if (pickles.length > 1) {
            (0, exit_1.exit)(`Found ${pickles.length} pickles for scenario: ${testTitle}`);
        }
        return pickle;
    }
