// Generated from: tests/e2e/features/spritecloud-com-read-book-performance-test.feature
...
test.describe('WwwSpritecloudCom — read journey', () => {
  ...
  test('read journey reaches its terminal page', { tag: ['@journey:read', '@priority:nice-to-have', '@smoke'] }, async ({ Given, When, Then, And, page }) => { 
    ...
    await When('I navigate directly to "/book-performance-test"', null, { page }); 
    await Then('I see the heading "Performance Test"', null, { page }); 
    await And('the page title contains "Book - Performance Test"', null, { page }); 
  });
  ...
  test('read — deep-link to the terminal page renders correctly', { tag: ['@journey:read', '@priority:nice-to-have', '@kind:resume'] }, async ({ Given, Then, page }) => { 
    await Given('I open the page "/book-performance-test"', null, { page }); 
    await Then('I see the heading "Performance Test"', null, { page }); 
  });
  ...
  test('read — back button after navigation returns to landing', { tag: ['@journey:read', '@priority:nice-to-have', '@kind:back-button'] }, async ({ Given, When, Then, page }) => { 
    await Given('I open the landing page', null, { page }); 
    await When('I click the link to "/book-performance-test"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests/e2e/features/spritecloud-com-read-book-performance-test.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":6,"pickleLine":20,"tags":["@journey:read","@priority:nice-to-have","@smoke"],"steps":[{"pwStepLine":7,"gherkinStepLine":21,"keywordType":"Context","textWithKeyword":"Given I open the landing page","stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":22,"keywordType":"Context","textWithKeyword":"And the page title contains \"spriteCloud - Test your software, not your reputation!\"","stepMatchArguments":[{"group":{"start":25,"value":"spriteCloud - Test your software, not your reputation!"}}]},{"pwStepLine":9,"gherkinStepLine":23,"keywordType":"Context","textWithKeyword":"And the main heading reads \"Test your software, not your reputation.\"","stepMatchArguments":[{"group":{"start":24,"value":"Test your software, not your reputation."}}]},{"pwStepLine":10,"gherkinStepLine":24,"keywordType":"Action","textWithKeyword":"When I navigate directly to \"/book-performance-test\"","stepMatchArguments":[{"group":{"start":24,"value":"/book-performance-test"}}]},{"pwStepLine":11,"gherkinStepLine":25,"keywordType":"Outcome","textWithKeyword":"Then I see the heading \"Performance Test\"","stepMatchArguments":[{"group":{"start":19,"value":"Performance Test"}}]},{"pwStepLine":12,"gherkinStepLine":26,"keywordType":"Outcome","textWithKeyword":"And the page title contains \"Book - Performance Test\"","stepMatchArguments":[{"group":{"start":25,"value":"Book - Performance Test"}}]}]},
  {"pwTestLine":15,"pickleLine":29,"tags":["@journey:read","@priority:nice-to-have","@kind:resume"],"steps":[{"pwStepLine":16,"gherkinStepLine":30,"keywordType":"Context","textWithKeyword":"Given I open the page \"/book-performance-test\"","stepMatchArguments":[{"group":{"start":17,"value":"/book-performance-test"}}]},{"pwStepLine":17,"gherkinStepLine":31,"keywordType":"Outcome","textWithKeyword":"Then I see the heading \"Performance Test\"","stepMatchArguments":[{"group":{"start":19,"value":"Performance Test"}}]}]},
  {"pwTestLine":20,"pickleLine":34,"tags":["@journey:read","@priority:nice-to-have","@kind:back-button"],"steps":[{"pwStepLine":21,"gherkinStepLine":35,"keywordType":"Context","textWithKeyword":"Given I open the landing page","stepMatchArguments":[]},{"pwStepLine":22,"gherkinStepLine":36,"keywordType":"Action","textWithKeyword":"When I click the link to \"/book-performance-test\"","stepMatchArguments":[{"group":{"start":21,"value":"/book-performance-test"}}]},{"pwStepLine":23,"gherkinStepLine":37,"keywordType":"Action","textWithKeyword":"When I go back in the browser history","stepMatchArguments":[]},{"pwStepLine":24,"gherkinStepLine":38,"keywordType":"Outcome","textWithKeyword":"Then the main heading reads \"Test your software, not your reputation.\"","stepMatchArguments":[{"group":{"start":24,"value":"Test your software, not your reputation."}}]}]},
