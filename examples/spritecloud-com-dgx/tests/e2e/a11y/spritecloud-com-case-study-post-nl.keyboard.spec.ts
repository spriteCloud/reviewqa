 ...
 *
 * Keyboard-only navigation for https://www.spritecloud.com/case-study---post-nl. v0.59 — depth parity:
...
test.describe('WwwSpritecloudCom — keyboard navigation @ https://www.spritecloud.com/case-study---post-nl', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/case-study---post-nl')
