 ...
 *
 * Keyboard-only navigation for https://www.spritecloud.com/book-free-scan. v0.59 — depth parity:
...
test.describe('WwwSpritecloudCom — keyboard navigation @ https://www.spritecloud.com/book-free-scan', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/book-free-scan')
