 ...
 *
 * Accessibility check for https://www.spritecloud.com/case-study-grandvision. v0.59 — depth parity: five
...
test.describe('WwwSpritecloudCom — accessibility @ https://www.spritecloud.com/case-study-grandvision', () => {
