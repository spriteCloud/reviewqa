 ...
 *
 * Keyboard-only navigation for https://www.spritecloud.com/guides/cucumber-gherkin. v0.59 — depth parity:
...
test.describe('WwwSpritecloudCom — keyboard navigation @ https://www.spritecloud.com/guides/cucumber-gherkin', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/guides/cucumber-gherkin')
