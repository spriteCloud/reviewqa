 ...
 *
 * Keyboard-only navigation for https://www.spritecloud.com/case-study-grandvision. v0.59 — depth parity:
...
test.describe('WwwSpritecloudCom — keyboard navigation @ https://www.spritecloud.com/case-study-grandvision', () => {
