 ...
 *
 * Mobile-web smoke for https://www.spritecloud.com/style-guide. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test.describe(`WwwSpritecloudCom — mobile-web @ ${deviceName} @ https://www.spritecloud.com/style-guide`, () => {
