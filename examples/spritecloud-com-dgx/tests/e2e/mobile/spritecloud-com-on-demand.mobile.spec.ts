 ...
 *
 * Mobile-web smoke for https://www.spritecloud.com/on-demand. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test.describe(`WwwSpritecloudCom — mobile-web @ ${deviceName} @ https://www.spritecloud.com/on-demand`, () => {
