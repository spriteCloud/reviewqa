 ...
 *
 * Keyboard-only navigation for https://books.toscrape.com/catalogue/category/books/default_15/index.html. v0.59 — depth parity:
...
test.describe('BooksToscrapeCom — keyboard navigation @ https://books.toscrape.com/catalogue/category/books/default_15/index.html', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/catalogue/category/books/default_15/index.html')
