 ...
 *
 * Mobile-web smoke for https://books.toscrape.com/index.html. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test.describe(`BooksToscrapeCom — mobile-web @ ${deviceName} @ https://books.toscrape.com/index.html`, () => {
