 ...
 *
 * Accessibility check for https://playwright.dev/community/feature-videos. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility on feature-videos page', () => {
  test('@kind:a11y @smoke — no serious or critical axe issues', async ({ page }) => {
  ...
  test('@kind:a11y @color-contrast — sufficient color contrast (AA)', async ({ page }) => {
  ...
  test('@kind:a11y @form-labels — all inputs have labels', async ({ page }) => {
