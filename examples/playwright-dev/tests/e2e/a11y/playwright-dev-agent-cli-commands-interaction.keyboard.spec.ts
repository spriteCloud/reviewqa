 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/commands/interaction. v0.59 — depth parity:
...
test.describe('Playwright — keyboard navigation @ https://playwright.dev/agent-cli/commands/interaction', () => {
