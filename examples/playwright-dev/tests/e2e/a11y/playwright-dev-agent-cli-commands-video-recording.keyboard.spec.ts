 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/commands/video-recording. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/commands/video-recording', () => {
  test('@kind:keyboard Tab cycles through the first 10 focusable elements', async ({ page }) => {
    await page.goto('/agent-cli/commands/video-recording')
  ...
  test('@kind:keyboard First tab-focused element shows a visible focus indicator', async ({ page }) => {
    await page.goto('/agent-cli/commands/video-recording')
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard Escape closes visible modal and returns focus to trigger', async ({ page }) => {
    await page.goto('/agent-cli/commands/video-recording')
  ...
  test('@kind:keyboard Tab from last focusable wraps or exits (no trap)', async ({ page }) => {
