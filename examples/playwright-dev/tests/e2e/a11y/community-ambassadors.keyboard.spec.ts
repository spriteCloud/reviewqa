 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://playwright.dev/community/ambassadors. v0.59 — depth parity:
...
test.describe('Playwright — keyboard navigation @ https://playwright.dev/community/ambassadors', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/community/ambassadors')
