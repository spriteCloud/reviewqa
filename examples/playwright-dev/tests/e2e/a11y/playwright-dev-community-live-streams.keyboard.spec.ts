 ...
 *
 * Keyboard-only navigation for https://playwright.dev/community/live-streams. v0.59 — depth parity:
...
test.describe('Playwright — keyboard navigation @ https://playwright.dev/community/live-streams', () => {
