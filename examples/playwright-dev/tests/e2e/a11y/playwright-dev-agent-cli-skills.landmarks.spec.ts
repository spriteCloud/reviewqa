 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/skills. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/agent-cli/skills', () => {
  ...
  test('@kind:a11y-landmarks heading levels follow sequential order (no skips)', async ({ page }) => {
