 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/console-eval. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility on /agent-cli/commands/console-eval', () => {
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA profile', async ({ page }) => {
