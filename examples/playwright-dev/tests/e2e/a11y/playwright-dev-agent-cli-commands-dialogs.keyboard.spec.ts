 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/commands/dialogs. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/commands/dialogs', () => {
  test('@kind:keyboard @smoke — Tab cycles through first 10 focusables', async ({ page }) => {
