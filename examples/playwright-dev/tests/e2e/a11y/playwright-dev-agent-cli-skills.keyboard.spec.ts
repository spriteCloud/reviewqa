 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/skills. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/skills', () => {
  test('@kind:keyboard @smoke Tab cycles through the first 10 focusable elements', async ({ page }) => {
    await page.goto('/agent-cli/skills')
