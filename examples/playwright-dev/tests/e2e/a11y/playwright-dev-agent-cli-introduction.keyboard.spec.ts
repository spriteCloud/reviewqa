 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/introduction. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/introduction', () => {
  test('@kind:keyboard @smoke tabbing cycles through the first 10 focusable elements', async ({ page }) => {
  ...
  test('@kind:keyboard @focus-indicator the first tab-focused element displays a visible focus indicator', async ({ page }) => {
    await page.goto('/agent-cli/introduction')
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @enter-space Enter triggers navigation or action for focused links or buttons', async ({ page }) => {
    await page.goto('/agent-cli/introduction')
  ...
  test('@kind:keyboard @no-trap Tabbing past the last focusable either wraps to the first or exits the page', async ({ page }) => {
