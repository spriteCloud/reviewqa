 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/sessions. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility: https://playwright.dev/agent-cli/sessions', () => {
  ...
  test('A11y WCAG 2.1 AA compliance gate', async ({ page }) => {
  ...
  test('A11y color contrast passes AA requirements', async ({ page }) => {
  ...
  test('A11y ARIA attributes used correctly', async ({ page }) => {
  ...
  test('A11y form inputs are programmatically labeled', async ({ page }) => {
