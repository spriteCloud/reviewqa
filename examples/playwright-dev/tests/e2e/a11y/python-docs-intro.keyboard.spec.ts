 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://playwright.dev/python/docs/intro. v0.59 — depth parity:
...
test.describe('Playwright — keyboard navigation @ https://playwright.dev/python/docs/intro', () => {
