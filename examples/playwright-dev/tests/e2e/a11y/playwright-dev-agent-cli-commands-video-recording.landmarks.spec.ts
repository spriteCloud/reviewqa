 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/commands/video-recording. v0.59 — depth
...
test.describe('Accessibility: Landmark structure for Playwright.dev video-recording page', () => {
  test('Smoke test: has one main, one h1, and at least one nav', async ({ page }) => {
  ...
  test('No focusable elements inside aria-hidden sections', async ({ page }) => {
    await page.goto('/agent-cli/commands/video-recording')
  ...
  test('Multiple landmarks each have unique accessible names', async ({ page }) => {
