 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/snapshots. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/agent-cli/snapshots', () => {
  test('@kind:a11y-landmarks @smoke single main element, one h1, and at least one nav element', async ({ page }) => {
    await page.goto('/agent-cli/snapshots')
  ...
  test('@kind:a11y-landmarks @landmark-names duplicate landmarks are given accessible names', async ({ page }) => {
