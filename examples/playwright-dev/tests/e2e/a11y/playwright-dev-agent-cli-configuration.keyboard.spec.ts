 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/configuration. v0.59 — depth parity:
...
test.describe('PlaywrightDev keyboard navigation (Agent CLI configuration page)', () => {
