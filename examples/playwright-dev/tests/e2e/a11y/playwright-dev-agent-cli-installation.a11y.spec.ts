 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/installation. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility at https://playwright.dev/agent-cli/installation', () => {
  ...
  test('@kind:a11y wcag-aa test — WCAG 2.1 AA-only profile', async ({ page }) => {
  ...
  test('@kind:a11y color-contrast test — color contrast meets AA threshold', async ({ page }) => {
  ...
  test('@kind:a11y aria-attrs test — ARIA attribute discipline', async ({ page }) => {
