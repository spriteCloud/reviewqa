 ...
 *
 * Keyboard-only navigation for https://playwright.dev/community/mcp-videos. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/community/mcp-videos', () => {
  test('@kind:keyboard @smoke cycle through the first 10 focusable elements with Tab', async ({ page }) => {
  ...
  test('@kind:keyboard @focus-indicator the first element focused by Tab shows a visible focus indicator', async ({ page }) => {
    await page.goto('/community/mcp-videos')
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @escape-dismiss pressing Escape closes the visible dialog and restores focus', async ({ page }) => {
    await page.goto('/community/mcp-videos')
