 ...
 *
 * Accessibility check for https://playwright.dev/community/conference-videos. v0.59 — depth parity: five
...
test.describe('Playwright — accessibility @ https://playwright.dev/community/conference-videos', () => {
