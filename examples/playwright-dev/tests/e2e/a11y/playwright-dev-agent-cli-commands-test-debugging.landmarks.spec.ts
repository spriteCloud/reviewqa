 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/commands/test-debugging. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/agent-cli/commands/test-debugging', () => {
  test('@kind:a11y-landmarks @smoke single main region, h1, and nav region', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @landmark-names landmark variants have unique labels', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @skip-link "skip to content" link is available (WCAG 2.4.1)', async ({ page }) => {
