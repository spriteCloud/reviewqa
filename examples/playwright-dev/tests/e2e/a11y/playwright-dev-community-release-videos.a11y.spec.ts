 ...
 *
 * Accessibility check for https://playwright.dev/community/release-videos. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility: /community/release-videos', () => {
  ...
  test('@kind:a11y color-contrast: AA-compliant color contrast', async ({ page }) => {
