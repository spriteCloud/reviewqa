 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/introduction. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility at agent-cli/introduction page', () => {
