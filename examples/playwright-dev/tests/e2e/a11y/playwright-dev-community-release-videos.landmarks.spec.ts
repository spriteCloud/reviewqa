 ...
 *
 * Accessibility landmark structure for https://playwright.dev/community/release-videos. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/community/release-videos', () => {
  test('@kind:a11y-landmarks @smoke verifies single main, h1, and nav elements', async ({ page }) => {
    await page.goto('/community/release-videos')
  ...
  test('@kind:a11y-landmarks @heading-hierarchy checks heading levels progress sequentially', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @landmark-names confirms duplicate landmarks have unique accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @skip-link confirms skip-to-content link or anchor exists (WCAG 2.4.1)', async ({ page }) => {
