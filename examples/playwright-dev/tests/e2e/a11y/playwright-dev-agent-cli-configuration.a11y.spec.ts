 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/configuration. v0.59 — depth parity: five
...
test.describe('Playwright — accessibility @ https://playwright.dev/agent-cli/configuration', () => {
