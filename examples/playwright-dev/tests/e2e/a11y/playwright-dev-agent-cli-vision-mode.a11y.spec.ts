 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/vision-mode. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility: https://playwright.dev/agent-cli/vision-mode', () => {
  ...
  test('@kind:a11y WCAG 2.1 AA compliance: only AA rules checked', async ({ page }) => {
  ...
  test('@kind:a11y color contrast: meets WCAG 2.1 AA minimum', async ({ page }) => {
  ...
  test('@kind:a11y form labels: all inputs have accessible labels', async ({ page }) => {
