 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/snapshots. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility checks on /agent-cli/snapshots', () => {
  test('@kind:a11y passes smoke test: no serious or critical axe violations', async ({ page }) => {
  ...
  test('@kind:a11y passes WCAG 2.1 AA-only profile test', async ({ page }) => {
  ...
  test('@kind:a11y passes color contrast AA compliance test', async ({ page }) => {
  ...
  test('@kind:a11y passes ARIA attribute discipline test', async ({ page }) => {
  ...
  test('@kind:a11y passes form labeling test', async ({ page }) => {
