 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/quick-start. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility at https://playwright.dev/agent-cli/quick-start', () => {
