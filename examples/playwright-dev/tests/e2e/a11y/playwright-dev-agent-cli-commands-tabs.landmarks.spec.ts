 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/commands/tabs. v0.59 — depth
...
test.describe('Accessibility landmark structure for playright.dev tabs page', () => {
  test('@kind:a11y-landmarks smoke test: exactly one main, one h1, and at least one nav region', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks no focusable elements inside aria-hidden subtrees', async ({ page }) => {
    await page.goto('/agent-cli/commands/tabs')
