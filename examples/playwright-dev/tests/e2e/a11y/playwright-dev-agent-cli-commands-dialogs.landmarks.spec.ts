 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/commands/dialogs. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/agent-cli/commands/dialogs', () => {
  test('@kind:a11y-landmarks @smoke Check for single main, h1, and at least one nav', async ({ page }) => {
    await page.goto('/agent-cli/commands/dialogs')
  ...
  test('@kind:a11y-landmarks @negative Confirm no focusable elements inside aria-hidden regions', async ({ page }) => {
    await page.goto('/agent-cli/commands/dialogs')
  ...
  test('@kind:a11y-landmarks @heading-hierarchy Verify headings follow sequential order', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @skip-link Confirm "skip to content" link is present (WCAG 2.4.1)', async ({ page }) => {
