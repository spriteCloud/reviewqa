 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/storage. v0.59 — depth parity: five
...
test.describe('PlaywrightDev — accessibility @ https://playwright.dev/agent-cli/commands/storage', () => {
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA compliance test', async ({ page }) => {
