 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://playwright.dev/mcp/introduction. v0.59 — depth
...
test.describe('Playwright — a11y landmarks @ https://playwright.dev/mcp/introduction', () => {
