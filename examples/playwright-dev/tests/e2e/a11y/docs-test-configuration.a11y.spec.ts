 ...
 * Generated by quail.
 *
 * Accessibility check for https://playwright.dev/docs/test-configuration. v0.59 — depth parity: five
...
test.describe('Playwright — accessibility @ https://playwright.dev/docs/test-configuration', () => {
