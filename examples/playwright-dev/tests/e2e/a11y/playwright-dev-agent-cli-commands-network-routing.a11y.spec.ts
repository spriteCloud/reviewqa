 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/network-routing. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility checks for network-routing page', () => {
  ...
  test('WCAG 2.1 AA compliance (no serious or critical issues)', async ({ page }) => {
