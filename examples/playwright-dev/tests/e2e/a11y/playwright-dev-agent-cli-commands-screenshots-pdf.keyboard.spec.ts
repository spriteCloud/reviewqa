 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/commands/screenshots-pdf. v0.59 — depth parity:
...
test.describe('PlaywrightDev: keyboard navigation on screenshots-pdf page', () => {
  test('Tab through the first 10 focusable elements', async ({ page }) => {
    await page.goto('/agent-cli/commands/screenshots-pdf')
  ...
  test('First tabbed element has a visible focus indicator', async ({ page }) => {
    await page.goto('/agent-cli/commands/screenshots-pdf')
    await page.keyboard.press('Tab')
  ...
  test('Escape closes a visible dialog and returns focus', async ({ page }) => {
    await page.goto('/agent-cli/commands/screenshots-pdf')
  ...
  test('Tabbing past the last focusable wraps or exits the page', async ({ page }) => {
