 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/commands/test-debugging. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/commands/test-debugging', () => {
  test('@kind:keyboard @smoke Tabs through the first 10 interactive elements', async ({ page }) => {
    await page.goto('/agent-cli/commands/test-debugging')
  ...
  test('@kind:keyboard @focus-indicator First item focused with Tab has a visible focus indicator', async ({ page }) => {
    await page.goto('/agent-cli/commands/test-debugging')
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @escape-dismiss Escape closes open dialog and returns focus to the trigger', async ({ page }) => {
    await page.goto('/agent-cli/commands/test-debugging')
  ...
  test('@kind:keyboard @no-trap Tab from last interactive element wraps or exits the page', async ({ page }) => {
