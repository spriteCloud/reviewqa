 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/sessions. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/agent-cli/sessions', () => {
  test('@kind:a11y-landmarks @smoke single main, h1, and nav elements', async ({ page }) => {
