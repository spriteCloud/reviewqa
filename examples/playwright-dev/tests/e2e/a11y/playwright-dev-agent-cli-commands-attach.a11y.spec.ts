 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/attach. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility — https://playwright.dev/agent-cli/commands/attach', () => {
  ...
  test('@kind:a11y color-contrast: all contrasts meet WCAG 2.1 AA threshold', async ({ page }) => {
  ...
  test('@kind:a11y form-labels: every form input has an accessible label', async ({ page }) => {
