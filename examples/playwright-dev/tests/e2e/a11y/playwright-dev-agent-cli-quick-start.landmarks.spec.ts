 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/quick-start. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/agent-cli/quick-start', () => {
  test('@kind:a11y-landmarks single main, h1, and nav elements', async ({ page }) => {
