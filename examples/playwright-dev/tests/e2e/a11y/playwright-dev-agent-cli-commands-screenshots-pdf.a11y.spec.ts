 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/screenshots-pdf. v0.59 — depth parity: five
...
test.describe('PlaywrightDev — accessibility @ https://playwright.dev/agent-cli/commands/screenshots-pdf', () => {
