 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/skills. v0.59 — depth parity: five
...
test.describe('PlaywrightDev — accessibility @ https://playwright.dev/agent-cli/skills', () => {
