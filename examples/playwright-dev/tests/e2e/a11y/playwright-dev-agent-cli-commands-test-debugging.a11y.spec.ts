 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/test-debugging. v0.59 — depth parity: five
...
test.describe('PlaywrightDev: accessibility check on test-debugging page', () => {
  ...
  test('color contrast: meets WCAG AA threshold', async ({ page }) => {
  ...
  test('ARIA attributes: no misuses or missing required attributes', async ({ page }) => {
  ...
  test('form labels: all inputs have accessible labels', async ({ page }) => {
