 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/capabilities. v0.59 — depth parity: five
...
test.describe('PlaywrightDev — accessibility check on https://playwright.dev/agent-cli/capabilities', () => {
  ...
  test('@kind:a11y WCAG 2.1 AA profile compliance check', async ({ page }) => {
  ...
  test('@kind:a11y ARIA attribute usage and validity check', async ({ page }) => {
