 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/commands/tabs. v0.59 — depth parity:
...
test.describe('Playwright — keyboard navigation @ https://playwright.dev/agent-cli/commands/tabs', () => {
