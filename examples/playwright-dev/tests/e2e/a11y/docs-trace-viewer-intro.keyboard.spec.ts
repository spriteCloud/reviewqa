 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://playwright.dev/docs/trace-viewer-intro. v0.59 — depth parity:
...
test.describe('Playwright — keyboard navigation @ https://playwright.dev/docs/trace-viewer-intro', () => {
