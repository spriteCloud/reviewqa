 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/sessions. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/sessions', () => {
  test('@kind:keyboard @smoke Tab through first 10 focusables', async ({ page }) => {
    await page.goto('/agent-cli/sessions')
