 ...
 *
 * Accessibility check for https://playwright.dev/search. v0.59 — depth parity: five
...
test.describe('PlaywrightDev — accessibility @ https://playwright.dev/search', () => {
  ...
  test('@kind:a11y ARIA attributes: valid usage and required children', async ({ page }) => {
