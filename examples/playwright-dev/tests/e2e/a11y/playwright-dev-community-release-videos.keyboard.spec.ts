 ...
 *
 * Keyboard-only navigation for https://playwright.dev/community/release-videos. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/community/release-videos', () => {
