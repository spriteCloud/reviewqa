 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://playwright.dev/docs/getting-started-cli. v0.59 — depth parity:
...
test.describe('Playwright — keyboard navigation @ https://playwright.dev/docs/getting-started-cli', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/docs/getting-started-cli')
