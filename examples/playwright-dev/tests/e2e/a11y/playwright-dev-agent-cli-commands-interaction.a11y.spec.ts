 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/interaction. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility checks on /agent-cli/commands/interaction page', () => {
  ...
  test('WCAG 2.1 AA-only profile compliance', async ({ page }) => {
  ...
  test('ARIA attributes follow correct usage rules', async ({ page }) => {
