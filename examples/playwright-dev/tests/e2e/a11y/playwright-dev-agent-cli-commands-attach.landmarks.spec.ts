 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/commands/attach. v0.59 — depth
...
test.describe('PlaywrightDev accessibility landmarks on the attach command page', () => {
  test('@kind:a11y-landmarks smoke test: single main, h1, and nav elements', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks check headings follow sequential hierarchy', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks verify duplicate landmarks have unique accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks confirm "skip to content" link is present (WCAG 2.4.1)', async ({ page }) => {
