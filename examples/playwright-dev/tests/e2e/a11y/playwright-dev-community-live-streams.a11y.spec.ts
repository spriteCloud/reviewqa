 ...
 *
 * Accessibility check for https://playwright.dev/community/live-streams. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility on the live streams page', () => {
  ...
  test('— passes WCAG 2.1 AA-only profile gate', async ({ page }) => {
  ...
  test('— passes color contrast threshold (AA level)', async ({ page }) => {
  ...
  test('— passes ARIA attribute discipline checks', async ({ page }) => {
  ...
  test('— passes form input labeling requirement', async ({ page }) => {
