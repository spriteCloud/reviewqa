 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/vision-mode. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/vision-mode', () => {
  test('@kind:keyboard @smoke Tab moves focus through the first 10 interactive elements', async ({ page }) => {
    await page.goto('/agent-cli/vision-mode')
  ...
  test('@kind:keyboard @enter-space Enter triggers links and buttons when focused', async ({ page }) => {
    await page.goto('/agent-cli/vision-mode')
