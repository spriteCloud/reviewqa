 ...
 *
 * Accessibility check for https://playwright.dev/community/mcp-videos. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility on /community/mcp-videos', () => {
  test('No serious or critical axe violations (WCAG 2a/2aa/21a/21aa)', async ({ page }) => {
  ...
  test('No serious or critical WCAG 2.1 AA violations', async ({ page }) => {
  ...
  test('All color contrast meets WCAG AA threshold', async ({ page }) => {
  ...
  test('No ARIA attribute violations', async ({ page }) => {
  ...
  test('All form inputs have programmatic labels', async ({ page }) => {
