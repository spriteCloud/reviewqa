 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/capabilities. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/agent-cli/capabilities', () => {
  test('@kind:a11y-landmarks single main region, h1, and nav element', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks headings follow sequential hierarchy (no skipping levels)', async ({ page }) => {
