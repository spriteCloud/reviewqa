 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://playwright.dev/docs/canary-releases. v0.59 — depth
...
test.describe('Playwright — a11y landmarks @ https://playwright.dev/docs/canary-releases', () => {
