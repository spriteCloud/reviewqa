 ...
 *
 * Keyboard-only navigation for https://playwright.dev/search. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/search', () => {
  ...
  test('@kind:keyboard @escape-dismiss Escape closes a modal/dialog and returns focus', async ({ page }) => {
    await page.goto('/search')
