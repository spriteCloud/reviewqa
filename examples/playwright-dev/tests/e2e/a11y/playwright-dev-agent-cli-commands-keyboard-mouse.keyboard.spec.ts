 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/commands/keyboard-mouse. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/commands/keyboard-mouse', () => {
  ...
  test('@kind:keyboard @escape-dismiss Escape closes a modal/dialog and returns focus to the trigger', async ({ page }) => {
    await page.goto('/agent-cli/commands/keyboard-mouse')
