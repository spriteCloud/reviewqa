 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/commands/screenshots-pdf. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/agent-cli/commands/screenshots-pdf', () => {
  ...
  test('@kind:a11y-landmarks "skip to content" link is available (WCAG 2.4.1)', async ({ page }) => {
