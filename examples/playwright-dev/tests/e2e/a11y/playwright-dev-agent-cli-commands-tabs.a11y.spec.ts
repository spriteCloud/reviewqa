 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/tabs. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility at /agent-cli/commands/tabs', () => {
  test('Smoke: no serious or critical axe-core violations', async ({ page }) => {
  ...
  test('Color contrast passes WCAG 2.1 AA minimum', async ({ page }) => {
  ...
  test('ARIA attribute usage is valid and complete', async ({ page }) => {
  ...
  test('All form inputs have programmatically associated labels', async ({ page }) => {
