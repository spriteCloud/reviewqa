 ...
 *
 * Accessibility landmark structure for https://playwright.dev/community/learn-videos. v0.59 — depth
...
test.describe('PlaywrightDev — a11y landmarks @ https://playwright.dev/community/learn-videos', () => {
  test('@kind:a11y-landmarks  smoke test: exactly one <main>, <h1>, and at least one <nav>', async ({ page }) => {
    await page.goto('/community/learn-videos')
  ...
  test('@kind:a11y-landmarks  heading hierarchy test: sequential heading levels (no skipping)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks  landmark names test: duplicate landmarks must have accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks  skip link test: "skip to content" affordance present (WCAG 2.4.1)', async ({ page }) => {
