 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/keyboard-mouse. v0.59 — depth parity: five
...
test.describe('PlaywrightDev — accessibility @ https://playwright.dev/agent-cli/commands/keyboard-mouse', () => {
  test('@kind:a11y @smoke no serious or critical accessibility issues', async ({ page }) => {
