 ...
 * Generated by quail.
 *
 * Accessibility check for https://playwright.dev/docs/running-tests. v0.59 — depth parity: five
...
test.describe('Playwright — accessibility @ https://playwright.dev/docs/running-tests', () => {
