 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://playwright.dev/docs/test-annotations. v0.59 — depth parity:
...
test.describe('Playwright — keyboard navigation @ https://playwright.dev/docs/test-annotations', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/docs/test-annotations')
