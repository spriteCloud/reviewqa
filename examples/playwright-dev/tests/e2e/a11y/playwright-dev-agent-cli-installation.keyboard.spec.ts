 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/installation. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/installation', () => {
  ...
  test('@kind:keyboard @escape-dismiss Escape closes an open modal and returns focus to the trigger', async ({ page }) => {
    await page.goto('/agent-cli/installation')
  ...
  test('@kind:keyboard @no-trap Tab from the last focusable element wraps to the first or exits the page', async ({ page }) => {
