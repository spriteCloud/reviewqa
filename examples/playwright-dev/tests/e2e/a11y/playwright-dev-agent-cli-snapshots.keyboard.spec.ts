 ...
 *
 * Keyboard-only navigation for https://playwright.dev/agent-cli/snapshots. v0.59 — depth parity:
...
test.describe('PlaywrightDev — keyboard navigation @ https://playwright.dev/agent-cli/snapshots', () => {
