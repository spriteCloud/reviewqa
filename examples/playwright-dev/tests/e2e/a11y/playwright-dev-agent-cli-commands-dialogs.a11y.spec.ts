 ...
 *
 * Accessibility check for https://playwright.dev/agent-cli/commands/dialogs. v0.59 — depth parity: five
...
test.describe('PlaywrightDev accessibility checks for /agent-cli/commands/dialogs', () => {
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA-only compliance', async ({ page }) => {
