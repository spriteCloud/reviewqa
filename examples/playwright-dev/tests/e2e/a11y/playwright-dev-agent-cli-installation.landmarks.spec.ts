 ...
 *
 * Accessibility landmark structure for https://playwright.dev/agent-cli/installation. v0.59 — depth
...
test.describe('PlaywrightDev — accessibility landmark structure for installation page', () => {
  test('@kind:a11y-landmarks @smoke ensures exactly one <main>, one <h1>, and at least one <nav>', async ({ page }) => {
    await page.goto('/agent-cli/installation')
  ...
  test('@kind:a11y-landmarks @negative ensures no focusable elements are inside aria-hidden regions', async ({ page }) => {
    await page.goto('/agent-cli/installation')
  ...
  test('@kind:a11y-landmarks @heading-hierarchy ensures headings follow sequential order (no skipped levels)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @landmark-names ensures multiple landmarks of same type have distinguishable names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @skip-link ensures a "skip to content" link is present (WCAG 2.4.1)', async ({ page }) => {
