 ...
 *
 * Performance baseline for https://playwright.dev/community/conference-videos. Asserts the page loads under
...
test.describe('Playwright — performance @ https://playwright.dev/community/conference-videos', () => {
