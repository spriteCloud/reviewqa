 ...
 * Generated by quail.
 *
 * Print-stylesheet baseline for https://playwright.dev/agent-cli/introduction. Asserts the page renders
...
test.describe('Playwright — print @ https://playwright.dev/agent-cli/introduction', () => {
