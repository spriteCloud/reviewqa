 ...
 * Generated by quail.
 *
 * Touch-interaction baseline for https://playwright.dev/docs/api/class-playwright. Uses an iPhone 13
...
test.describe('Playwright — touch gestures @ https://playwright.dev/docs/api/class-playwright', () => {
