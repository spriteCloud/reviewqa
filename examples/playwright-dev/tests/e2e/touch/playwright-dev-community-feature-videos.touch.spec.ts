 ...
 *
 * Touch-interaction baseline for https://playwright.dev/community/feature-videos. Uses an iPhone 13
...
test.describe('PlaywrightDev — touch gestures @ https://playwright.dev/community/feature-videos', () => {
  test('@kind:touch @smoke long-press on primary CTA does not trigger double click', async ({ page }) => {
  ...
  test('@kind:touch @swipe horizontal swipe on page maintains interactivity', async ({ page }) => {
    await page.goto('/community/feature-videos')
  ...
  test('@kind:touch @pinch-zoom synthesized pinch maintains page interactivity', async ({ page }) => {
    await page.goto('/community/feature-videos')
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('@kind:touch @scroll-momentum rapid vertical swipes don’t break layout', async ({ page }) => {
    await page.goto('/community/feature-videos')
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('@kind:touch @tap-then-rotate tap during screen rotation doesn’t double-fire', async ({ browser }) => {
