 ...
 * Generated by quail.
 *
 * Touch-interaction baseline for https://playwright.dev/agent-cli/introduction. Uses an iPhone 13
...
test.describe('Playwright — touch gestures @ https://playwright.dev/agent-cli/introduction', () => {
