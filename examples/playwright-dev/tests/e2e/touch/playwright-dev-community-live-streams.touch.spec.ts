 ...
 *
 * Touch-interaction baseline for https://playwright.dev/community/live-streams. Uses an iPhone 13
...
test.describe('PlaywrightDev — touch gestures @ https://playwright.dev/community/live-streams', () => {
