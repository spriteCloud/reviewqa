 ...
 *
 * Mobile-web smoke for https://playwright.dev/community/live-streams. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test.describe(`PlaywrightDev — mobile-web @ ${deviceName} @ https://playwright.dev/community/live-streams`, () => {
