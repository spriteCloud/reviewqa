...
test.describe('EsWikipedia — API contract @ https://es.wikipedia.org/wiki/Wikipedia:Portada', () => {
  ...
  test('@kind:api @negative unicode payload does not 5xx', async ({ request }) => {
    const response = await request.post('https://es.wikipedia.org/wiki/Wikipedia:Portada', {
      form: {
        'skin-client-pref-vector-feature-custom-font-size-group': 'café-niño-用户-🎉-',
        'skin-client-pref-vector-feature-custom-font-size-group': 'café-niño-用户-🎉-',
        'skin-client-pref-vector-feature-custom-font-size-group': 'café-niño-用户-🎉-',
      },
    })
  ...
  test('@kind:api @negative sql-injection-shaped input does not 5xx', async ({ request }) => {
    ...
    const response = await request.post('https://es.wikipedia.org/wiki/Wikipedia:Portada', {
      form: {
        'skin-client-pref-vector-feature-custom-font-size-group': payload,
        'skin-client-pref-vector-feature-custom-font-size-group': payload,
        'skin-client-pref-vector-feature-custom-font-size-group': payload,
      },
    })
  ...
  test('@kind:api @negative null-byte injection does not 5xx', async ({ request }) => {
    const response = await request.post('https://es.wikipedia.org/wiki/Wikipedia:Portada', {
      form: {
        'skin-client-pref-vector-feature-custom-font-size-group': 'value\x00malicious',
        'skin-client-pref-vector-feature-custom-font-size-group': 'value\x00malicious',
        'skin-client-pref-vector-feature-custom-font-size-group': 'value\x00malicious',
      },
    })
