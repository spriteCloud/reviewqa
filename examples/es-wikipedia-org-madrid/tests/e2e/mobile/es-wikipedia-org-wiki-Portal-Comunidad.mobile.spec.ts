 ...
 *
 * Mobile-web smoke for https://es.wikipedia.org/wiki/Portal:Comunidad. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test.describe(`EsWikipediaOrg — mobile-web @ ${deviceName} @ https://es.wikipedia.org/wiki/Portal:Comunidad`, () => {
