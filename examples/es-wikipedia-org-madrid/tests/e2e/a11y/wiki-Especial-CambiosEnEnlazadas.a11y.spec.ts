 ...
 * Generated by quail.
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Especial:CambiosEnEnlazadas?hidebots=1&hidecategorization=1&hideWikibase=1&target=Wikipedia%3APortada&limit=50&days=1&urlversion=2. v0.59 — depth parity: five
...
test.describe('EsWikipedia — accessibility @ https://es.wikipedia.org/wiki/Especial:CambiosEnEnlazadas?hidebots=1&hidecategorization=1&hideWikibase=1&target=Wikipedia%3APortada&limit=50&days=1&urlversion=2', () => {
