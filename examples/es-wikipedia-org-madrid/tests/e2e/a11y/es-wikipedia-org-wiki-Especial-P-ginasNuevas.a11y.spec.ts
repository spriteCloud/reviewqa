 ...
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Especial:P%C3%A1ginasNuevas. v0.59 — depth parity: five
...
test.describe('EsWikipediaOrg — accessibility @ https://es.wikipedia.org/wiki/Especial:P%C3%A1ginasNuevas', () => {
