 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://es.wikipedia.org/wiki/Especial:CambiosEnEnlazadas?hidebots=1&hidecategorization=1&hideWikibase=1&target=Wikipedia%3APortada&limit=50&days=1&urlversion=2. v0.59 — depth
...
test.describe('EsWikipedia — a11y landmarks @ https://es.wikipedia.org/wiki/Especial:CambiosEnEnlazadas?hidebots=1&hidecategorization=1&hideWikibase=1&target=Wikipedia%3APortada&limit=50&days=1&urlversion=2', () => {
