 ...
 * Generated by quail.
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Ayuda:Introducci%C3%B3n. v0.59 — depth parity: five
...
test.describe('EsWikipedia — accessibility @ https://es.wikipedia.org/wiki/Ayuda:Introducci%C3%B3n', () => {
