 ...
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Wikipedia:Art%C3%ADculos_destacados. v0.59 — depth parity: five
...
test.describe('EsWikipediaOrg — accessibility @ https://es.wikipedia.org/wiki/Wikipedia:Art%C3%ADculos_destacados', () => {
