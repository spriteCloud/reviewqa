 ...
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Coordenadas_geogr%C3%A1ficas. v0.59 — depth parity: five
...
test.describe('EsWikipediaOrg — accessibility @ https://es.wikipedia.org/wiki/Coordenadas_geogr%C3%A1ficas', () => {
