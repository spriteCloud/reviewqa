 ...
 *
 * Keyboard-only navigation for https://es.wikipedia.org/wiki/Portal:Actualidad. v0.59 — depth parity:
...
test.describe('EsWikipediaOrg — keyboard navigation @ https://es.wikipedia.org/wiki/Portal:Actualidad', () => {
