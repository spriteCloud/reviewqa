 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://es.wikipedia.org/wiki/Especial:CambiosEnEnlazadas?hidebots=1&hidecategorization=1&hideWikibase=1&target=Wikipedia%3APortada&limit=50&days=1&urlversion=2. v0.59 — depth parity:
...
test.describe('EsWikipedia — keyboard navigation @ https://es.wikipedia.org/wiki/Especial:CambiosEnEnlazadas?hidebots=1&hidecategorization=1&hideWikibase=1&target=Wikipedia%3APortada&limit=50&days=1&urlversion=2', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/wiki/Especial:CambiosEnEnlazadas')
