 ...
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Pa%C3%B1ol. v0.59 — depth parity: five
...
test.describe('EsWikipediaOrg — accessibility @ https://es.wikipedia.org/wiki/Pa%C3%B1ol', () => {
