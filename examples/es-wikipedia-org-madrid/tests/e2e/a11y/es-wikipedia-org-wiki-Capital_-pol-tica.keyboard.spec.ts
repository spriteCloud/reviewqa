 ...
 *
 * Keyboard-only navigation for https://es.wikipedia.org/wiki/Capital_%28pol%C3%ADtica%29. v0.59 — depth parity:
...
test.describe('EsWikipediaOrg — keyboard navigation @ https://es.wikipedia.org/wiki/Capital_%28pol%C3%ADtica%29', () => {
