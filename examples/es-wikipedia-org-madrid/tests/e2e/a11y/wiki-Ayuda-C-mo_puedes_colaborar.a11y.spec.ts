 ...
 * Generated by quail.
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Ayuda:C%C3%B3mo_puedes_colaborar. v0.59 — depth parity: five
...
test.describe('EsWikipedia — accessibility @ https://es.wikipedia.org/wiki/Ayuda:C%C3%B3mo_puedes_colaborar', () => {
