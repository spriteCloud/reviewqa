 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://es.wikipedia.org/wiki/Especial:LoQueEnlazaAqu%C3%AD/Wikipedia:Portada. v0.59 — depth
...
test.describe('EsWikipedia — a11y landmarks @ https://es.wikipedia.org/wiki/Especial:LoQueEnlazaAqu%C3%AD/Wikipedia:Portada', () => {
