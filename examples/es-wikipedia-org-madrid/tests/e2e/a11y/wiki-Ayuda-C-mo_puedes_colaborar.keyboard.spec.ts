 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://es.wikipedia.org/wiki/Ayuda:C%C3%B3mo_puedes_colaborar. v0.59 — depth parity:
...
test.describe('EsWikipedia — keyboard navigation @ https://es.wikipedia.org/wiki/Ayuda:C%C3%B3mo_puedes_colaborar', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/wiki/Ayuda:Cómo_puedes_colaborar')
