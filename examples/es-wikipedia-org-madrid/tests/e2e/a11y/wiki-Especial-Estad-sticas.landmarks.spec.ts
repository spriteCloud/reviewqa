 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://es.wikipedia.org/wiki/Especial:Estad%C3%ADsticas. v0.59 — depth
...
test.describe('EsWikipedia — a11y landmarks @ https://es.wikipedia.org/wiki/Especial:Estad%C3%ADsticas', () => {
