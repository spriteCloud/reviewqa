 ...
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Archivo:Bandera_de_la_ciudad_de_Madrid.svg. v0.59 — depth parity: five
...
test.describe('EsWikipediaOrg — accessibility @ https://es.wikipedia.org/wiki/Archivo:Bandera_de_la_ciudad_de_Madrid.svg', () => {
