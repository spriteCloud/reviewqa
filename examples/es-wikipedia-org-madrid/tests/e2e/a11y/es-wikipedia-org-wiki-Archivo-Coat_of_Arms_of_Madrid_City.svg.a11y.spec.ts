 ...
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Archivo:Coat_of_Arms_of_Madrid_City.svg. v0.59 — depth parity: five
...
test.describe('EsWikipediaOrg — accessibility @ https://es.wikipedia.org/wiki/Archivo:Coat_of_Arms_of_Madrid_City.svg', () => {
