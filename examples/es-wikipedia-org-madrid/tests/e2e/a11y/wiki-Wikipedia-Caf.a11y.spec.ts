 ...
 * Generated by quail.
 *
 * Accessibility check for https://es.wikipedia.org/wiki/Wikipedia:Caf%C3%A9. v0.59 — depth parity: five
...
test.describe('EsWikipedia — accessibility @ https://es.wikipedia.org/wiki/Wikipedia:Caf%C3%A9', () => {
