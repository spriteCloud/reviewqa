 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://es.wikipedia.org/wiki/The_Confessions_Tour. v0.59 — depth parity:
...
test.describe('EsWikipedia — keyboard navigation @ https://es.wikipedia.org/wiki/The_Confessions_Tour', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/wiki/The_Confessions_Tour')
