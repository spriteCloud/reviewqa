 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://es.wikipedia.org/wiki/%C3%81lbum_de_estudio. v0.59 — depth parity:
...
test.describe('EsWikipedia — keyboard navigation @ https://es.wikipedia.org/wiki/%C3%81lbum_de_estudio', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/wiki/Álbum_de_estudio')
