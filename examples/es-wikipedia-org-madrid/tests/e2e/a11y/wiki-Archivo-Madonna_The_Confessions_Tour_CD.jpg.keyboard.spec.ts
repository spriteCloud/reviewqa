 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://es.wikipedia.org/wiki/Archivo:Madonna_The_Confessions_Tour_CD.jpg. v0.59 — depth parity:
...
test.describe('EsWikipedia — keyboard navigation @ https://es.wikipedia.org/wiki/Archivo:Madonna_The_Confessions_Tour_CD.jpg', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/wiki/Archivo:Madonna_The_Confessions_Tour_CD.jpg')
