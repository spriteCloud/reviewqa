 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://es.wikipedia.org/wiki/Confessions_Tour. v0.59 — depth
...
test.describe('EsWikipedia — a11y landmarks @ https://es.wikipedia.org/wiki/Confessions_Tour', () => {
