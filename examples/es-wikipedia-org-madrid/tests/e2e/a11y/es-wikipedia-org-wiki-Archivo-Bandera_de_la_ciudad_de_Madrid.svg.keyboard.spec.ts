 ...
 *
 * Keyboard-only navigation for https://es.wikipedia.org/wiki/Archivo:Bandera_de_la_ciudad_de_Madrid.svg. v0.59 — depth parity:
...
test.describe('EsWikipediaOrg — keyboard navigation @ https://es.wikipedia.org/wiki/Archivo:Bandera_de_la_ciudad_de_Madrid.svg', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/wiki/Archivo:Bandera_de_la_ciudad_de_Madrid.svg')
