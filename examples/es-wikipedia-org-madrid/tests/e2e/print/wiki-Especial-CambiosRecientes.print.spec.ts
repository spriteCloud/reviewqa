 ...
 * Generated by quail.
 *
 * Print-stylesheet baseline for https://es.wikipedia.org/wiki/Especial:CambiosRecientes?hidebots=1&hidecategorization=1&hideWikibase=1&limit=50&days=1&urlversion=2. Asserts the page renders
...
test.describe('EsWikipedia — print @ https://es.wikipedia.org/wiki/Especial:CambiosRecientes?hidebots=1&hidecategorization=1&hideWikibase=1&limit=50&days=1&urlversion=2', () => {
