 ...
 *
 * Touch-interaction baseline for https://es.wikipedia.org/wiki/Portal:Comunidad. Uses an iPhone 13
...
test.describe('EsWikipediaOrg — touch gestures @ https://es.wikipedia.org/wiki/Portal:Comunidad', () => {
