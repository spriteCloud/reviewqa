 ...
 * Generated by quail.
 *
 * Touch-interaction baseline for https://es.wikipedia.org/wiki/Especial:CambiosRecientes?hidebots=1&hidecategorization=1&hideWikibase=1&limit=50&days=1&urlversion=2. Uses an iPhone 13
...
test.describe('EsWikipedia — touch gestures @ https://es.wikipedia.org/wiki/Especial:CambiosRecientes?hidebots=1&hidecategorization=1&hideWikibase=1&limit=50&days=1&urlversion=2', () => {
