 ...
 *
 * Touch-interaction baseline for https://es.wikipedia.org/wiki/Portal:Actualidad. Uses an iPhone 13
...
test.describe('EsWikipediaOrg — touch gestures @ https://es.wikipedia.org/wiki/Portal:Actualidad', () => {
