 ...
 *
 * Integration-layer DB SCAFFOLD for https://gohugo.io. Emitted when the
...
test.describe('GohugoIo — integration: DB scaffold (skipped)', () => {
  test.skip('@kind:integration-db @wireable @round-trip CREATE / INSERT / SELECT / DELETE round-trip', async ({ request }) => {
    ...
    //   3. POST to https://gohugo.io, then SELECT to confirm the row landed
