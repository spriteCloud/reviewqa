 ...
 *
 * Mobile-web smoke for https://gohugo.io/templates/new-templatesystem-overview. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test.describe(`GohugoIo — mobile-web @ ${deviceName} @ https://gohugo.io/templates/new-templatesystem-overview`, () => {
