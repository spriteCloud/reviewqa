 ...
 *
 * Keyboard-only navigation for https://gohugo.io/templates/new-templatesystem-overview. v0.59 — depth parity:
...
test.describe('GohugoIo — keyboard navigation @ https://gohugo.io/templates/new-templatesystem-overview', () => {
