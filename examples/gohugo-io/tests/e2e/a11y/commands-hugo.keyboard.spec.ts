 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://gohugo.io/commands/hugo/. v0.59 — depth parity:
...
test.describe('Gohugo — keyboard navigation @ https://gohugo.io/commands/hugo/', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/commands/hugo/')
