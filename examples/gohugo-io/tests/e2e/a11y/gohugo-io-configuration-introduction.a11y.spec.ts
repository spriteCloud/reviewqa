 ...
 *
 * Accessibility check for https://gohugo.io/configuration/introduction. v0.59 — depth parity: five
...
test.describe('GohugoIo — accessibility @ https://gohugo.io/configuration/introduction', () => {
