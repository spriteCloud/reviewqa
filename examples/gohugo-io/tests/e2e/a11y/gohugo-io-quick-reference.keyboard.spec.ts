 ...
 *
 * Keyboard-only navigation for https://gohugo.io/quick-reference. v0.59 — depth parity:
...
test.describe('GohugoIo — keyboard navigation @ https://gohugo.io/quick-reference', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/quick-reference')
