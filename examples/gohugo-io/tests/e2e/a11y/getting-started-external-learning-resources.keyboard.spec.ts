 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://gohugo.io/getting-started/external-learning-resources/. v0.59 — depth parity:
...
test.describe('Gohugo — keyboard navigation @ https://gohugo.io/getting-started/external-learning-resources/', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/getting-started/external-learning-resources/')
