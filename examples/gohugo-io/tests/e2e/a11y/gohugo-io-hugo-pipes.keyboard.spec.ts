 ...
 *
 * Keyboard-only navigation for https://gohugo.io/hugo-pipes. v0.59 — depth parity:
...
test.describe('GohugoIo — keyboard navigation @ https://gohugo.io/hugo-pipes', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/hugo-pipes')
