 ...
 *
 * Keyboard-only navigation for https://gohugo.io/render-hooks/introduction. v0.59 — depth parity:
...
test.describe('GohugoIo — keyboard navigation @ https://gohugo.io/render-hooks/introduction', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/render-hooks/introduction')
