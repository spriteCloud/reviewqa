 ...
 *
 * Keyboard-only navigation for https://gohugo.io/getting-started. v0.59 — depth parity:
...
test.describe('GohugoIo — keyboard navigation @ https://gohugo.io/getting-started', () => {
