 ...
 *
 * Keyboard-only navigation for https://gohugo.io/templates/introduction. v0.59 — depth parity:
...
test.describe('GohugoIo — keyboard navigation @ https://gohugo.io/templates/introduction', () => {
  test('@kind:keyboard @smoke tab through the first 10 focusables', async ({ page }) => {
    await page.goto('/templates/introduction')
