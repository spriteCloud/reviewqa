...
Feature: Gohugo — read journey
  ...
  Scenario: read journey reaches its terminal page
    ...
    When I navigate directly to "/contribute/"
    And the page title contains "Contribute to the Hugo project"
