 ...
 *
 * Mobile-web smoke for https://petstore3.swagger.io. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test.describe(`Petstore3SwaggerIo — mobile-web @ ${deviceName} @ https://petstore3.swagger.io`, () => {
