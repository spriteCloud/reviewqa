 ...
 * Generated by quail.
 *
 * Mobile-web smoke for https://www.ing.nl/zakelijk. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} viewport renders correctly`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} landscape rotation maintains page interactivity`, async ({ browser }) => {
