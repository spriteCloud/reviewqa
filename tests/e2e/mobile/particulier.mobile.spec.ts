 ...
 * Generated by quail.
 *
 * Mobile-web smoke for https://www.ing.nl/particulier. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} page loads and headings display correctly`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} page remains functional after rotating to landscape`, async ({ browser }) => {
