...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} viewport loads correctly`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} page remains functional after landscape rotation`, async ({ browser }) => {
