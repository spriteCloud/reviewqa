 ...
 * Generated by quail.
 *
 * Mobile-web smoke for https://www.ing.nl/private-banking. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} viewport renders without layout issues`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} landscape rotation keeps the page usable`, async ({ browser }) => {
