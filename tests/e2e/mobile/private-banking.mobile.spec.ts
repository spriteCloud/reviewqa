...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} viewport loads without layout breakage`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} landscape mode keeps the page usable`, async ({ browser }) => {
