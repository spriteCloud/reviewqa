...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} page loads and shows the main heading`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} switching to landscape shows headings correctly`, async ({ browser }) => {
