 ...
 * Generated by quail.
 *
 * Mobile-web smoke for https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen. v0.56 — depth parity. Where the
...
for (const deviceName of DEVICES) {
  test(`@kind:mobile @smoke @device:${deviceName} renders without visual or functional breakage`, async ({ browser }) => {
  ...
  test(`@kind:mobile @orientation @device:${deviceName} landscape orientation keeps the page interactive`, async ({ browser }) => {
