 ...
 * Generated by quail.
 *
 * Touch-interaction baseline for https://www.ing.nl/private-banking. Uses an iPhone 13
...
test.describe('Ing — touch gestures @ https://www.ing.nl/private-banking', () => {
  ...
  test('@kind:touch @pinch-zoom Synthetic pinch-zoom keeps the page interactive', async ({ page }) => {
    await page.goto('/private-banking', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('@kind:touch @tap-then-rotate Tap during orientation change does not duplicate click fire', async ({ browser }) => {
