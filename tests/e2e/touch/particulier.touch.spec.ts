 ...
 * Generated by quail.
 *
 * Touch-interaction baseline for https://www.ing.nl/particulier. Uses an iPhone 13
...
test.describe('ING — Touch gestures on mobile (iPhone 13, hasTouch) for https://www.ing.nl/particulier', () => {
  test('@kind:touch @smoke Long-pressing the primary CTA should fire only one click', async ({ page }) => {
  ...
  test('@kind:touch @swipe Horizontal swiping the page should leave it responsive and navigable', async ({ page }) => {
    await page.goto('/particulier', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:touch @pinch-zoom Zooming via synthesized pinch (wheel + Ctrl) should not break UI', async ({ page }) => {
    await page.goto('/particulier', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('@kind:touch @scroll-momentum Rapid flick-scrolling vertically should preserve layout integrity', async ({ page }) => {
    await page.goto('/particulier', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('@kind:touch @tap-then-rotate Tapping just before/or during orientation change should not trigger duplicate clicks', async ({ browser }) => {
