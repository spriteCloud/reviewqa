...
test.describe('ING — touch gestures on https://www.ing.nl/particulier', () => {
  test('@kind:touch @smoke long-press on the main CTA does not fire twice', async ({ page }) => {
  ...
  test('@kind:touch @swipe horizontal swipe on the page keeps it responsive', async ({ page }) => {
    await page.goto('/particulier', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:touch @pinch-zoom simulated pinch-zoom keeps the page functional', async ({ page }) => {
    await page.goto('/particulier', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('@kind:touch @scroll-momentum rapid vertical flicks do not break the layout', async ({ page }) => {
    await page.goto('/particulier', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('@kind:touch @tap-then-rotate tap during screen rotation does not fire twice', async ({ browser }) => {
