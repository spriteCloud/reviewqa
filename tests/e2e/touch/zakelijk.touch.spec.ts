 ...
 * Generated by quail.
 *
 * Touch-interaction baseline for https://www.ing.nl/zakelijk. Uses an iPhone 13
...
test.describe('Ing — touch gestures @ https://www.ing.nl/zakelijk', () => {
  test('@kind:touch @smoke long-press on the primary CTA triggers at most one click', async ({ page }) => {
  ...
  test('@kind:touch @swipe horizontal swipe leaves the page fully interactive', async ({ page }) => {
    await page.goto('/zakelijk', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:touch @pinch-zoom simulated pinch-zoom leaves the page responsive', async ({ page }) => {
    await page.goto('/zakelijk', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('@kind:touch @scroll-momentum rapid vertical swipes preserve page layout', async ({ page }) => {
    await page.goto('/zakelijk', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('@kind:touch @tap-then-rotate tap followed by orientation change fires only one click', async ({ browser }) => {
