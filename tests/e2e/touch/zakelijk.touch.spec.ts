...
test.describe('ING — Touch gesture tests on https://www.ing.nl/zakelijk', () => {
  test('@kind:touch @smoke Long-press on primary CTA does not fire twice', async ({ page }) => {
  ...
  test('@kind:touch @swipe Horizontal swipe across document keeps page interactive', async ({ page }) => {
    await page.goto('/zakelijk', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:touch @pinch-zoom Simulated pinch-zoom keeps page interactive', async ({ page }) => {
    await page.goto('/zakelijk', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('@kind:touch @scroll-momentum Rapid vertical swipes do not break layout', async ({ page }) => {
    await page.goto('/zakelijk', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('@kind:touch @tap-then-rotate Tap during orientation change does not fire twice', async ({ browser }) => {
