 ...
 * Generated by quail.
 *
 * Touch-interaction baseline for https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen. Uses an iPhone 13
...
test.describe('ING — touch interaction baseline at https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen', () => {
  test('@kind:touch @smoke long-press on the main call-to-action does not trigger multiple clicks', async ({ page }) => {
  ...
  test('@kind:touch @swipe horizontal swipe across the page does not break interactivity', async ({ page }) => {
    await page.goto('/particulier/hypotheek/hypotheek-berekenen', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:touch @pinch-zoom simulated pinch-zoom gesture preserves page interactivity', async ({ page }) => {
    await page.goto('/particulier/hypotheek/hypotheek-berekenen', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('@kind:touch @scroll-momentum quick vertical flicks do not corrupt the layout', async ({ page }) => {
    await page.goto('/particulier/hypotheek/hypotheek-berekenen', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('@kind:touch @tap-then-rotate tapping while screen orientation changes does not cause duplicate clicks', async ({ browser }) => {
