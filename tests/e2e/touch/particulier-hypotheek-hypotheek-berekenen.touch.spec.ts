...
test.describe('ING — touch interaction tests for mortgage calculator page', () => {
  test('@kind:touch @smoke long-press on primary CTA fires click only once', async ({ page }) => {
  ...
  test('@kind:touch @swipe horizontal swipe leaves page fully interactive', async ({ page }) => {
    await page.goto('/particulier/hypotheek/hypotheek-berekenen', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:touch @pinch-zoom simulated pinch gesture preserves page interactivity', async ({ page }) => {
    await page.goto('/particulier/hypotheek/hypotheek-berekenen', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
  ...
  test('@kind:touch @scroll-momentum rapid vertical flicks do not corrupt layout', async ({ page }) => {
    await page.goto('/particulier/hypotheek/hypotheek-berekenen', { waitUntil: 'domcontentloaded' })
    const viewport = page.viewportSize() || { width: 390, height: 844 }
    const cx = viewport.width / 2
  ...
  test('@kind:touch @tap-then-rotate tap during orientation change fires once', async ({ browser }) => {
