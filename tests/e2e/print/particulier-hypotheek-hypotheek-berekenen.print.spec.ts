 ...
 * Generated by quail.
 *
 * Print-stylesheet baseline for https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen. Asserts the page renders
...
test.describe('ING — print page render test for mortgage calculator', () => {
  test('verifies page renders correctly in print mode (smoke test)', async ({ page }) => {
