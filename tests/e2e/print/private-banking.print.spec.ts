 ...
 * Generated by quail.
 *
 * Print-stylesheet baseline for https://www.ing.nl/private-banking. Asserts the page renders
...
test.describe('ING private banking print stylesheet', () => {
  test('renders page correctly when printed', async ({ page }) => {
