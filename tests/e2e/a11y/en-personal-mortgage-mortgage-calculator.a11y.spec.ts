...
test.describe('ING mortgage calculator — accessibility', () => {
  ...
  test('wcag-aa: passes WCAG 2.1 AA-only checks', async ({ page }) => {
  ...
  test('color-contrast: contrast meets AA thresholds', async ({ page }) => {
