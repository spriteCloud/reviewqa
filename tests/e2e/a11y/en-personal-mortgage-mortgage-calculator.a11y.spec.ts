 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.ing.nl/en/personal/mortgage/mortgage-calculator. v0.59 — depth parity: five
...
test.describe('ING accessibility checks for the mortgage calculator page', () => {
  ...
  test('meets WCAG 2.1 AA requirements', async ({ page }) => {
  ...
  test('meets color contrast requirements for AA compliance', async ({ page }) => {
  ...
  test('has no ARIA attribute misuse', async ({ page }) => {
