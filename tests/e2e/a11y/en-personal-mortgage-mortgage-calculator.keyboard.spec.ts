 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://www.ing.nl/en/personal/mortgage/mortgage-calculator. v0.59 — depth parity:
...
test.describe('Ing — keyboard navigation @ https://www.ing.nl/en/personal/mortgage/mortgage-calculator', () => {
  ...
  test('@kind:keyboard @focus-indicator First tabbed-to element shows a visible focus indicator', async ({ page }) => {
    await page.goto('/en/personal/mortgage/mortgage-calculator', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @escape-dismiss Escape key closes an open dialog and returns focus', async ({ page }) => {
    await page.goto('/en/personal/mortgage/mortgage-calculator', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:keyboard @no-trap Tabbing past the last interactive element wraps or exits', async ({ page }) => {
