...
test.describe('ING — accessibility check for private banking site', () => {
  ...
  test('a11y WCAG 2.1 AA-only compliance check', async ({ page }) => {
  ...
  test('a11y contrast check: AA-compliant color ratios', async ({ page }) => {
  ...
  test('a11y ARIA use validation', async ({ page }) => {
  ...
  test('a11y form labels: all inputs properly labeled', async ({ page }) => {
