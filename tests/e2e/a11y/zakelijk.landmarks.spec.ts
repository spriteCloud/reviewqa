 ...
 *   heading-hierarchy   — headings follow sequential hierarchy (no skips) (no h1→h3 jumps)
...
test.describe('Ing — a11y landmarks @ https://www.ing.nl/zakelijk', () => {
  ...
  test('@kind:a11y-landmarks @heading-hierarchy headings follow sequential hierarchy (no skips)', async ({ page }) => {
