 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.ing.nl/zakelijk. v0.59 — depth
...
test.describe('Ing — a11y landmarks @ https://www.ing.nl/zakelijk', () => {
  test('@kind:a11y-landmarks smoke: validates a single main region, one h1, and at least one nav', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks heading hierarchy: checks headings follow sequential order without skips', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks landmark names: confirms duplicate landmarks have accessible names', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks skip link: verifies presence of a "skip to content" link per WCAG 2.4.1', async ({ page }) => {
