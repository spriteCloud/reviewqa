 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://www.ing.nl/zakelijk. v0.59 — depth parity:
...
test.describe('Ing — keyboard navigation @ https://www.ing.nl/zakelijk', () => {
  test('@kind:keyboard @smoke presses Tab through the first 10 focusable elements', async ({ page }) => {
  ...
  test('@kind:keyboard @enter-space Pressing Enter activates the currently focused link or button', async ({ page }) => {
    await page.goto('/zakelijk', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:keyboard @no-trap pressing Tab from the last focusable element wraps back or exits the page', async ({ page }) => {
