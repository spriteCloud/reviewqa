 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://www.ing.nl/particulier. v0.59 — depth parity:
...
test.describe('Ing — keyboard navigation @ https://www.ing.nl/particulier', () => {
  ...
  test('@kind:keyboard @no-trap pressing Tab after the last focusable wraps focus or exits the page', async ({ page }) => {
