 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.ing.nl/private-banking. v0.59 — depth
...
test.describe('Ing — a11y landmarks @ https://www.ing.nl/private-banking', () => {
  test('@kind:a11y-landmarks verifies single main element, single h1, and at least one nav', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks confirms no interactive elements are inside aria-hidden regions', async ({ page }) => {
    await page.goto('/private-banking', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:a11y-landmarks ensures headings follow sequential order without skipping levels', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks checks every duplicate landmark has a unique accessible name', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks confirms presence of a skip-to-content link meeting WCAG 2.4.1', async ({ page }) => {
