 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.ing.nl/en/personal/mortgage/mortgage-calculator. v0.59 — depth
...
test.describe('ING — accessibility landmark structure on mortgage calculator', () => {
  test('@kind:a11y-landmarks @smoke single main, h1, and nav region present', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @heading-hierarchy headings follow a sequential hierarchy', async ({ page }) => {
