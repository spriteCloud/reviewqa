 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.ing.nl/zakelijk. v0.59 — depth parity: five
...
test.describe('Ing — accessibility @ https://www.ing.nl/zakelijk', () => {
  ...
  test('@kind:a11y @aria-attrs valid ARIA attribute usage', async ({ page }) => {
