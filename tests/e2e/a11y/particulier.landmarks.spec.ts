 ...
 *   heading-hierarchy   — headings follow sequential hierarchy (no skipped levels) (no h1→h3 jumps)
...
test.describe('Ing — a11y landmarks @ https://www.ing.nl/particulier', () => {
  test('@kind:a11y-landmarks @smoke exactly one main region, one h1, and at least one nav region', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @heading-hierarchy headings follow sequential hierarchy (no skipped levels)', async ({ page }) => {
  ...
  test('@kind:a11y-landmarks @landmark-names multiple identical landmarks each have unique accessible names', async ({ page }) => {
