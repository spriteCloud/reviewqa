 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://www.ing.nl/private-banking. v0.59 — depth parity:
...
test.describe('Ing — keyboard navigation @ https://www.ing.nl/private-banking', () => {
  ...
  test('@kind:keyboard @no-trap Tabbing past the last interactive element wraps or exits the page', async ({ page }) => {
