 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.ing.nl/particulier. v0.59 — depth parity: five
...
test.describe('ING — accessibility for https://www.ing.nl/particulier', () => {
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA-compliant', async ({ page }) => {
