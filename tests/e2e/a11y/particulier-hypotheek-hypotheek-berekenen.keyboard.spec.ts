 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen. v0.59 — depth parity:
 ...
 *   no-trap         — pressing Tab after the last interactive element either wraps or exits page (no trap)
 *
...
test.describe('Ing — keyboard navigation @ https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen', () => {
  test('@kind:keyboard @smoke navigate with Tab through the first 10 interactive elements', async ({ page }) => {
  ...
  test('@kind:keyboard @focus-indicator the first element focused via Tab shows a visible focus indicator', async ({ page }) => {
    await page.goto('/particulier/hypotheek/hypotheek-berekenen', { waitUntil: 'domcontentloaded' })
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @enter-space Enter triggers action on focused links or buttons', async ({ page }) => {
    await page.goto('/particulier/hypotheek/hypotheek-berekenen', { waitUntil: 'domcontentloaded' })
  ...
  test('@kind:keyboard @no-trap pressing Tab after the last interactive element either wraps or exits page the page', async ({ page }) => {
