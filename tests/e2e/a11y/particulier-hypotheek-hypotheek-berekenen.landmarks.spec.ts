 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen. v0.59 — depth
...
test.describe('Ing — a11y landmarks @ https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen', () => {
  test('smoke: exactly one <main>, one <h1>, and at least one <nav>', async ({ page }) => {
  ...
  test('heading hierarchy: headings increase sequentially without skipping levels', async ({ page }) => {
  ...
  test('skip link: "skip to content" affordance omitted violates WCAG 2.4.1', async ({ page }) => {
