 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen. v0.59 — depth parity: five
...
test.describe('ING accessibility — https://www.ing.nl/particulier/hypotheek/hypotheek-berekenen', () => {
  ...
  test('all form inputs have a programmatic label', async ({ page }) => {
